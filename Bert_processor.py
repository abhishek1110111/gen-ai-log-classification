...
model_classification = joblib.load("training_dataset/models/log_classifier.joblib")


def classification_with_bert(log_message):
    ''' Classify the given log message using BERT model.'''
...
if __name__ == "__main__":
    ...
    for log in logs:
        label = classification_with_bert(log)
        print(log, "->", label)
